...
{-# LINE 24 "libraries/unix/./System/Posix/Semaphore.hsc" #-}

{-# LINE 25 "libraries/unix/./System/Posix/Semaphore.hsc" #-}
...
{-# LINE 51 "libraries/unix/./System/Posix/Semaphore.hsc" #-}
                 (if semExclusive flags then 128 else 0)
{-# LINE 52 "libraries/unix/./System/Posix/Semaphore.hsc" #-}
        semOpen' cname =
