...
{-# LINE 22 "libraries/unix/./System/Posix/Process.hsc" #-}
    forkProcess,

{-# LINE 24 "libraries/unix/./System/Posix/Process.hsc" #-}
    executeFile,
...
{-# LINE 64 "libraries/unix/./System/Posix/Process.hsc" #-}
...
{-# LINE 80 "libraries/unix/./System/Posix/Process.hsc" #-}
import GHC.TopHandler	( runIO )

{-# LINE 82 "libraries/unix/./System/Posix/Process.hsc" #-}


{-# LINE 86 "libraries/unix/./System/Posix/Process.hsc" #-}
...
{-# LINE 162 "libraries/unix/./System/Posix/Process.hsc" #-}
     elapsed <- throwErrnoIfMinus1 "getProcessTimes" (c_times p_tms)
     ut  <- ((\hsc_ptr -> peekByteOff hsc_ptr 0))  p_tms
{-# LINE 164 "libraries/unix/./System/Posix/Process.hsc" #-}
     st  <- ((\hsc_ptr -> peekByteOff hsc_ptr 8))  p_tms
{-# LINE 165 "libraries/unix/./System/Posix/Process.hsc" #-}
     cut <- ((\hsc_ptr -> peekByteOff hsc_ptr 16)) p_tms
{-# LINE 166 "libraries/unix/./System/Posix/Process.hsc" #-}
     cst <- ((\hsc_ptr -> peekByteOff hsc_ptr 24)) p_tms
{-# LINE 167 "libraries/unix/./System/Posix/Process.hsc" #-}
...
{-# LINE 238 "libraries/unix/./System/Posix/Process.hsc" #-}
...
{-# LINE 263 "libraries/unix/./System/Posix/Process.hsc" #-}
...
{-# LINE 365 "libraries/unix/./System/Posix/Process.hsc" #-}
waitOptions False True  = (3)
{-# LINE 366 "libraries/unix/./System/Posix/Process.hsc" #-}
waitOptions True  False = 0
waitOptions True  True  = (2)
{-# LINE 368 "libraries/unix/./System/Posix/Process.hsc" #-}
