{-# LINE 1 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}
module System.Console.Haskeline.Backend.IConv(
{-# LINE 2 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}
        setLocale,
        getCodeset,
        openEncoder,
        openDecoder,
...
{-# LINE 17 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}
import Data.ByteString.Internal (createAndTrim')

{-# LINE 19 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}
import qualified Data.ByteString as B
import qualified Data.ByteString.UTF8 as UTF8
import Data.Maybe (fromMaybe)


{-# LINE 24 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}

{-# LINE 25 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}

{-# LINE 26 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}
...
setLocale oldLocale = (maybeWith withCString) oldLocale $ \loc_p -> do
    c_setlocale (0) loc_p >>= maybePeek peekCString
{-# LINE 70 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}

-----------------
-- Getting the encoding

type NLItem = Int32
{-# LINE 75 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}

foreign import ccall nl_langinfo :: NLItem -> IO CString

getCodeset :: IO String
getCodeset = do
    str <- nl_langinfo (14) >>= peekCString
{-# LINE 81 "libraries/haskeline/./System/Console/Haskeline/Backend/IConv.hsc" #-}
