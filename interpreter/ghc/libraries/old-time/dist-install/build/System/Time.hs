{-# LINE 1 "libraries/old-time/./System/Time.hsc" #-}
{-# OPTIONS_GHC -fno-warn-unused-binds #-}
{-# LINE 2 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 111 "libraries/old-time/./System/Time.hsc" #-}

{-# LINE 112 "libraries/old-time/./System/Time.hsc" #-}

{-# LINE 113 "libraries/old-time/./System/Time.hsc" #-}


{-# LINE 123 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 134 "libraries/old-time/./System/Time.hsc" #-}
import Foreign.C

{-# LINE 136 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 270 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 352 "libraries/old-time/./System/Time.hsc" #-}
-- -----------------------------------------------------------------------------
...
{-# LINE 362 "libraries/old-time/./System/Time.hsc" #-}
zone x      = ((\hsc_ptr -> peekByteOff hsc_ptr 48)) x
{-# LINE 363 "libraries/old-time/./System/Time.hsc" #-}
gmtoff x    = ((\hsc_ptr -> peekByteOff hsc_ptr 40)) x
{-# LINE 364 "libraries/old-time/./System/Time.hsc" #-}


{-# LINE 411 "libraries/old-time/./System/Time.hsc" #-}

{-# LINE 412 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 423 "libraries/old-time/./System/Time.hsc" #-}
toCalendarTime =  clockToCalendarTime_reentrant (throwAwayReturnPointer localtime_r) False

{-# LINE 427 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 435 "libraries/old-time/./System/Time.hsc" #-}
toUTCTime      =  unsafePerformIO . clockToCalendarTime_reentrant (throwAwayReturnPointer gmtime_r) True

{-# LINE 439 "libraries/old-time/./System/Time.hsc" #-}


{-# LINE 464 "libraries/old-time/./System/Time.hsc" #-}
throwAwayReturnPointer :: (Ptr CTime -> Ptr CTm -> IO (Ptr CTm))
                       -> (Ptr CTime -> Ptr CTm -> IO (       ))
throwAwayReturnPointer fun x y = fun x y >> return ()


{-# LINE 476 "libraries/old-time/./System/Time.hsc" #-}


{-# LINE 478 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 483 "libraries/old-time/./System/Time.hsc" #-}
      fun p_timer p_tm
      clockToCalendarTime_aux is_utc p_tm psec

{-# LINE 486 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 490 "libraries/old-time/./System/Time.hsc" #-}
    minute <-  ((\hsc_ptr -> peekByteOff hsc_ptr 4)) p_tm :: IO CInt
{-# LINE 491 "libraries/old-time/./System/Time.hsc" #-}
    hour  <-  ((\hsc_ptr -> peekByteOff hsc_ptr 8)) p_tm :: IO CInt
{-# LINE 492 "libraries/old-time/./System/Time.hsc" #-}
    mday  <-  ((\hsc_ptr -> peekByteOff hsc_ptr 12)) p_tm :: IO CInt
{-# LINE 493 "libraries/old-time/./System/Time.hsc" #-}
    mon   <-  ((\hsc_ptr -> peekByteOff hsc_ptr 16)) p_tm :: IO CInt
{-# LINE 494 "libraries/old-time/./System/Time.hsc" #-}
    year  <-  ((\hsc_ptr -> peekByteOff hsc_ptr 20)) p_tm :: IO CInt
{-# LINE 495 "libraries/old-time/./System/Time.hsc" #-}
    wday  <-  ((\hsc_ptr -> peekByteOff hsc_ptr 24)) p_tm :: IO CInt
{-# LINE 496 "libraries/old-time/./System/Time.hsc" #-}
    yday  <-  ((\hsc_ptr -> peekByteOff hsc_ptr 28)) p_tm :: IO CInt
{-# LINE 497 "libraries/old-time/./System/Time.hsc" #-}
    isdst <-  ((\hsc_ptr -> peekByteOff hsc_ptr 32)) p_tm :: IO CInt
{-# LINE 498 "libraries/old-time/./System/Time.hsc" #-}
    zone' <-  zone p_tm
    tz    <-  gmtoff p_tm
...
{-# LINE 520 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 533 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 575 "libraries/old-time/./System/Time.hsc" #-}
...
{-# LINE 729 "libraries/old-time/./System/Time.hsc" #-}
-- -----------------------------------------------------------------------------
