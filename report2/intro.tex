...
Following is some lists describing how the work in this project has been
partitioned.
...
parser was only successfull for very few programs.
...
\item A refactoring of the code written previously, in order to make it better 
